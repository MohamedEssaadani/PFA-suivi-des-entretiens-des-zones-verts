...
public class DbInitService implements IDbInitService {
	...
	public void initTaches() {
		Stream.of("Nettoyage des mauvaises herbes", "élimination des mauvaises herbes", "Arrosage",
				"Traitement des plantes", "Préparation des sols", "Aménagement de jardins",
				"Gestion et soin des potagers et vergers", "Préparer les sols avant de planter les végétaux",
				"Effectuer les semis", "protéger les plantations", "Remplacer les plantations en fin de cycle",
				"Entretenir les outils et les machines").forEach(name -> {
	...
	public void initTypeZoneVert() {
		Stream.of("Grands espaces verts", "Parcs de quartier", "Parcs historique", "Bois et Espaces semi-naturels",
				"Jardins familliaux").forEach(name -> {
